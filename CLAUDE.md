...
Next.js 16 全栈 Web 应用。AI 驱动的设计作品评审平台，覆盖作品评审（单张设计图）和作品集评审（完整 PDF 作品集）两大模式。目标用户为设计类学生。
...
- 第 6 维按作品形态（12%）: 展板→信息组织, UI→用户体验, 海报→传播记忆点, 等
...
3. **导师点评仍是模板生成**: `single-work-feedback.ts` 基于维度分+场景选模板，非 AI 看图写
4. **作品集无缩略图**: PDF 无预览图
